%Use it for single z-slice images
...
%change working directory, not neccessay but makes things easier
pn = uigetdir();
cd(pn)
...
Spectralprocess %please open this file and run step by step ; gets rois and signals
